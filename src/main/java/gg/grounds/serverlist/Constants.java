...
/** Shared constants for the Grounds Server List mod. */
public final class Constants {
    private Constants() {}

    public static final String MOD_ID = "grounds";
    public static final String MOD_NAME = "Grounds DevMod";
    public static final Logger LOG = LoggerFactory.getLogger("grounds-devmod");
