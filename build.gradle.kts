...
dependencies {
    // Minecraft 26.1.2 ships deobfuscated in this timeline — the version manifest
    ...
    // module jars with plain `implementation` (not loom's modImplementation): MC 26.1.2 is
